# Multinomial ACL model for multi-trait association test
 ...
 - Three tests are implemented: an ombinus m-DF chi-square test; two 1-DF chi-square tests assuming common effect or common scaled effect.

# References
B. Wu and J.S. Pankow (2015). Statistical methods for association tests of multiple continuous traits in genome-wide association studies. *Annals of human genetics*, 79(4), 282-293.
